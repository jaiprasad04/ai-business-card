          ...
          <nav className="flex flex-col gap-3">
            ...
            {status === "authenticated" ? (
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded bg-red-500/10 text-red-500 py-3 text-sm font-bold hover:bg-red-500/20 transition-all border border-red-500/20"
              >
                <FiLogOut size={16} />
                <span>Sign Out</span>
              </button>
              ...
              <Link
                href="/login"
                onClick={() => setIsOpen(false)}
                className="flex w-full items-center justify-center rounded bg-primary text-white py-3 text-sm font-bold hover:bg-primary-hover transition-all shadow-md shadow-primary/20"
              >
                Sign In
              </Link>
            )}
        ...
        <div className="fixed inset-0 z-[300] flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
          <div className="bg-bg-card border border-divider w-full max-w-md rounded-xl p-6 space-y-5 shadow-2xl animate-scale-up">
            ...
            <p className="text-xs text-secondary-text leading-relaxed">
              Use your own <strong>MuAPI Key</strong> to generate business card designs directly without consuming or purchasing website credits.
            </p>
